...
from ..models import PuzzleSummary, SolveResult, legacy_dict_to_puzzle
from ..solver.service import DEFAULT_PUZZLE_DIR, SOLVE_MODES, SolveInterrupted, discover_puzzles, resolve_puzzle_target, solve_puzzle_file, summarize_puzzle as _summarize_puzzle
